package com.example.common.irecyclerview;
...
public class ClassicRefreshHeaderView extends FrameLayout implements RefreshTrigger {
    int[] mIds = {R.id.m_animation_iv_image1, R.id.m_animation_iv_image2, R.id.m_animation_iv_image3,
            R.id.m_animation_iv_image4, R.id.m_animation_iv_image5};
    ImageView[] mAnimationIvImage = new ImageView[5];
    Animation[] mInAnim = new Animation[5];
    Animation[] mOutAnim = new Animation[5];
    ...
    protected void onFinishInflate() {
        ...
        for(int i = 0; i < 5; i++) {
            mAnimationIvImage[i] = (ImageView) findViewById(mIds[i]);
